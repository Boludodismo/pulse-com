...
export default function TechnicalCatalog() {
  ...
  const [stockForm, setStockForm] = useState({ baseUnit: "un", purchaseUnit: "cx", unitsPerPackage: "1", packageQuantity: "", minStock: "", minStockUnit: "base" as "base" | "package", targetStock: "", avgPrice: "", supplierId: "", lotNumber: "", expiresAt: "", notes: "" });
  ...
  const addToStock = trpc.catalog.addToStock.useMutation({
    onSuccess: () => {
      ...
      setStockForm({ baseUnit: "un", purchaseUnit: "cx", unitsPerPackage: "1", packageQuantity: "", minStock: "", minStockUnit: "base", targetStock: "", avgPrice: "", supplierId: "", lotNumber: "", expiresAt: "", notes: "" });
  ...
  const submitStock = () => {
    ...
    const minimumConversion = stockForm.minStockUnit === "package" ? Number(stockForm.unitsPerPackage) : 1;
    ...
    addToStock.mutate({
      ...
      targetStock: stockForm.targetStock ? Number(stockForm.targetStock) : normalizedMinimum,
