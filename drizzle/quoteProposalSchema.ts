...
export const quoteProposals = mysqlTable("quote_proposals", {
  ...
  sentSource: varchar("sent_source", { length: 24 }),
  respondedAt: datetime("responded_at", { mode: "string" }),
  responseSource: varchar("response_source", { length: 24 }),
  responseText: text("response_text"),
  responseByUserId: int("response_by_user_id"),
  questionAt: datetime("question_at", { mode: "string" }),
